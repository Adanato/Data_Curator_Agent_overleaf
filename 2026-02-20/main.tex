...
The curation agent is a thin abstraction layer on top of the AutoGen Core framework.
It implements a single-agent \textbf{reason--act--observe} loop that iteratively calls tools
...
\subsection{Conversation History (Reason--Act--Observe Loop)}
...
\subsection{System Prompt (Preselection Style)}
